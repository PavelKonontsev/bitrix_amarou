...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
    ...
    if(check_bitrix_sessid())
    {
        if(empty($arParams["REQUIRED_FIELDS"]) || !in_array("NONE", $arParams["REQUIRED_FIELDS"]))
        {
            ...
            if((empty($arParams["REQUIRED_FIELDS"]) || in_array("industry", $arParams["REQUIRED_FIELDS"])) && strlen($_POST["industry"]) <= 3)
                $arResult["ERROR_MESSAGE"][] = GetMessage("MF_REQ_INDUSTRY");
        ...
        if(empty($arResult["ERROR_MESSAGE"]))
        {
            ...
            $_SESSION["MF_industry"] = htmlspecialcharsbx($_POST["industry"]);
        ...
        $arResult["industry"] = htmlspecialcharsbx($_POST["industry"]);
    }
    else
...
if(empty($arResult["ERROR_MESSAGE"]))
{
    ...
    else
    {
        ...
        if(strlen($_SESSION["MF_industry"]) > 0)
            $arResult["industry"] = htmlspecialcharsbx($_SESSION["MF_industry"]);
    }
}
