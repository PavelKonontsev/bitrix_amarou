...
)
{
	$icon_url_template = "<script>\n".
		...
		"}\n".
		"</script>\n".
		"<a href=\"http://twitter.com/home/?status=#PAGE_URL#+#PAGE_TITLE_ORIG#\" onclick=\"return twitter_click_".$arResult["COUNTER"]."('#PAGE_URL#');\" target=\"_blank\" class=\"btn btn__social btn__social__lg btn__secondary\" title=\"".$title."\"><i class=\"fab fa-twitter\"></i><span>Share on ".$name."</span></a>\n";
}
else
{
	$icon_url_template = "<script>\n".
